...
struct LocalizationTests {
    ...
    private static let everyString: [KeyPath<Strings, String>] = [
        ...
        \.settledUp,
        \.nextCustomers, \.yourCustomers, \.whoDoYouSellTo, \.customersSetupBody,
        ...
        \.seeBills, \.nextCustomer, \.voidedNote, \.paidInFullCash,
        ...
        \.editSupplier, \.saveSupplier, \.removeFromSuppliers, \.supplierNameExample,
        \.noPurchasesYet, \.purchaseLabel, \.boughtFromThem, \.youOwe,
        \.owedToSuppliers, \.nothingOwedOut, \.chooseSupplierFromTheList,
        \.voidAndRemoveStock, \.purchaseVoidedNote, \.purchasedInPeriod, \.paidOutInPeriod,

...
struct LocalizationTests {
    ...
    private static let everyString: [KeyPath<Strings, String>] = [
        ...
        \.transferredInLabel, \.transferredOutLabel, \.moveBalanceToCustomer, \.moveBalanceToSupplier,
        \.moveABalance, \.amountToMove, \.whyMoved, \.whyMovedExample, \.movedBalanceIsAnEntry,
        \.enterAnAmountToMove, \.nobodyToMoveTo,
        ...
        \.receivedFrom, \.paidTo, \.amountPaid,
        \.accountAfterThisReceipt, \.previousBalance, \.balanceNow,
        ...
        \.supplier, \.whoYouBoughtFrom, \.howMany, \.paidPerPiece,
        ...
        \.searchRecords, \.nothingMatches, \.billLabel, \.voucherLabel, \.expenseLabel,
        ...
        \.owedToSuppliers, \.nothingOwedOut, \.youHaveNotPaidYet, \.noPaymentYet,
        \.chooseSupplierFromTheList,
        ...
        \.receivableSummary, \.payableSummary, \.columnCustomer, \.customerBalances,
        \.totalReceivable, \.totalPayable, \.nothingReceivable, \.nothingPayable,
        \.expenseReport, \.columnWhatItWentOn,
        \.salesReport, \.purchaseReport, \.paymentsReport,

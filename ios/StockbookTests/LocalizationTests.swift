...
struct LocalizationTests {
    ...
    private static let everyString: [KeyPath<Strings, String>] = [
        ...
        \.settings, \.soldToday, \.billsStat, \.recentBills,
        \.noBillsToday, \.saveFile, \.backupWrittenNote, \.backupMissingNote,
        \.itemsTitle, \.search, \.nothingAddedYet, \.shelfEmpty,
        \.billsTitle, \.noBillsEver, \.voidAndRestock, \.voided,
        \.allCustomers, \.customerLabel, \.transactions, \.pendingPayment,
        \.nothingPending, \.newBill, \.cartEmpty, \.addAProductPlaceholder,
        \.scanABill, \.scanReading, \.scanFilledIn, \.scanCheckFigures,
        \.scanNothingRead, \.scanRawTitle, \.scanTryAgain, \.scanFromTheBill,
        \.scanLineIsRight, \.doneAdding, \.addAnotherItem, \.oneFewer,
        \.oneMore, \.noProductsYet, \.reset, \.customerName,
        \.paidInFull, \.partPayment, \.paidNow, \.total,
        \.balance, \.saveBill, \.enterCustomerName, \.billSaved,
        \.billDetailTitle, \.seeBills, \.nextCustomer, \.voidedNote,
        \.paidInFullCash, \.newProduct, \.editProduct, \.productName,
        \.productNameExample, \.inStock, \.buyingPrice, \.sellingPrice,
        \.addStock, \.removeThisProduct, \.setPriceAboveCost, \.quickAdd,
        \.purchaseEntry, \.supplier, \.whoDeliveredIt, \.howMany,
        \.paidPerPiece, \.recordPurchase, \.welcomeToStockbook, \.welcomeBody,
        \.yourName, \.businessOwnerName, \.yourShelves, \.whatDoYouStock,
        \.stockNamesBody, \.commonHardwareLines, \.nothingAddedYetKicker, \.nextStockAndPrices,
        \.stockAndPrices, \.stockAndPricesBody, \.youPay, \.youSell,
        \.openTheShop, \.allSet, \.thisPhone, \.businessOwner,
        \.productsStat, \.customersStat, \.languageSection, \.languageAndCurrency,
        \.notBackedUpYet, \.currencySection, \.currencyNote, \.setupCurrencyNote,

...
/**
 * One purchase. Tapping it opens the document, which is where it can be changed.
 *
 * A file of its own, beside `BillRow`, since the pane it used to live at the
 * bottom of folded into `BookScreen`. Not private: `PartyScreen` draws the same
 * row under one supplier, and a second copy of it would be two rows to keep in
 * step.
 */
@Composable
    ...
    Row(
        ...
        Column(modifier = Modifier.weight(1f)) {
            Text(
                ...
                // row headed by an empty string reads as a purchase whose product
            ...
            Text(
                // `12 × SAR 60` is the arithmetic behind a purchase of one thing,
